...
phasefile = "/home/eriks/baboondiversity/data/PG_panu3_phased_chromosomes_4_7_2021/chrX/chrX.females.v2.phase"
recombfile = "/home/eriks/baboondiversity/data/PG_panu3_phased_chromosomes_4_7_2021/chrX/chrX.females.v2.recombfile"
...
name_suffix = "chrX_females_lai"
cp_dir = "steps/"+name_suffix+"/"
em_fraction = 5
donor_populations = ["kindae", "ursinus", "papio", "hamadryas"]
...
def summarize_em(i_files, em_dir):
    """Function to summarize the EM for chromopainter"""
    inputs = i_files
...
def cp_run_copy(i_number, cp_dir, em_dir, phasefile, recombfile, label_file, pop_list):
    ...
    {chromopainter} -g {phasefile} -r {recombfile} -t {label_file} -f {pop_list} {i} {i} -i 10 -ip -n $ne -M $mut -o {o_name}
...
# Definition of possible recipient populations.
pop_list_infile_D = pop_list_infile_D.loc[pop_list_infile_D.Pop_list.isin(donor_populations)]
